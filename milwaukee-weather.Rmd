...
So there is some pattern between snow and wind speed. The median wind speed on days that it snowed is greater than the median wind speed on all other days, and the data is normally distributed for both sets.
